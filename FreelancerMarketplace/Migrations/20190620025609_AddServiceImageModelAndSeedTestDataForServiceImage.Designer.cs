...
namespace FreelancerMarketplace.Migrations
{
    ...
    [Migration("20190620025609_AddServiceImageModelAndSeedTestDataForServiceImage")]
    partial class AddServiceImageModelAndSeedTestDataForServiceImage
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FreelancerMarketplace.Models.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            CategoryId = 1,
                            CategoryName = "Audio",
                            CreatedDate = new DateTime(2019, 6, 20, 12, 56, 9, 22, DateTimeKind.Local).AddTicks(2480),
                            IsDeleted = false
                        },
                        new
                        {
            ...
            modelBuilder.Entity("FreelancerMarketplace.Models.ServiceImage", b =>
                {
            ...
            modelBuilder.Entity("FreelancerMarketplace.Models.ServiceImage", b =>
                {
                    b.HasOne("FreelancerMarketplace.Models.Service", "Service")
